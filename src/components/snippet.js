...
export default function Snippet({
  children,
  data: {
    snippet: { title, slug, date, excerpt, published, editUrl },
    site: { siteMetadata },
  },
  ...props
}) {
    ...
    >
      <div className="grid md:grid-cols-4 grid-cols-1 gap-8 md:mt-4 mt-0">
        <div className="md:col-span-3">
          <h4 className="text-base uppercase tracking-wide">Snippet</h4>
        ...
        <aside className="h-full border-t-2 md:border-none border-gray-200">
          <div className="flex flex-col items-start md:sticky top-0 pt-5">
            <div className="flex flex-wrap items-center">
              <TimeAgo className="text-xs text-gray-700" datetime={date} />
            </div>
            <button
